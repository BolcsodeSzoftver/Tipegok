...
<?php $__env->startSection('UjdolgozoTartalom'); ?>
    <div class="row">
        <div class="col">
            <div class="form-outline">
                ...
                <label class="form-label" for="form8Example1">Vezeték név</label>
            </div>
        </div>
        <div class="col-6">
            <div class="form-outline">
                <input type="text" id="form8Example1" class="form-control" />
                <label class="form-label" for="form8Example1">Kereszt név</label>
            </div>
        </div>
    </div>
    <hr />
    ...
    <div class="row">
        <div class="col">
            <div class="form-outline">
                <input type="email" id="form8Example1" class="form-control" />
                <label class="form-label" for="form8Example1">Email cím</label>
            </div>
        </div>
        <div class="col">
            <div class="form-outline">
                <input type="tel" id="form8Example2" class="form-control" />
