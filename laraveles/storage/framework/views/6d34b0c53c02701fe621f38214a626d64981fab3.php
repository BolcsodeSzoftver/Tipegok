                            ...
                            <table class="table table-bordered mb-5" id="tabla">
                                ...
                                <tbody class="adatokDolgozoAllapot">
                                    <?php $__empty_1 = true; $__currentLoopData = $alkalmazotts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php $__currentLoopData = $bolcsodek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bolcsi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($data->allapot === 0 and $data->bolcsode_id === $bolcsi->id): ?>
                                                <tr class="dolgozo">
                                                    <td class="modositAllapot">
                                                        <div class="form-outline">
                                                            <input type="hidden" id="allapot" class="form-control"
                                                                name="allapot">
                                                        </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form action="/api/dolgozo" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="urlap">
                                    <div id="adatok">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" class="form-control" id="alkalmazottId"
                                                    name="alkalmazottId">
                                            </div>
                                            <div class="col">
                                                <input type="text" class="form-control" id="bolcsodeId"
                                                    name="bolcsodeId">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="bruttoAlapber"
                                                    name="bruttoAlapber">
                                            </div>
                                            <div class="col">
                                                <label for="hetiMunkaOra">Heti munkaóra</label>
                                                <input type="text" class="form-control" id="hetiMunkaOra"
                                                    name="hetiMunkaOra">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="besorolasiBetu"
                                                    name="besorolasiBetu">
                                            </div>
                                            <div class="col">
                                                <label for="besorolasiSzam">Besorolási szám</label>
                                                <input type="text" class="form-control" id="besorolasiSzam"
                                                    name="besorolasiSzam">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="feorAzonosito"
                                                name="feorAzonosito">
                                        </div>
                                        <div class="col">
                                            <label for="agazataiPotlek">Ágazati pótlék</label>
                                            <input type="text" class="form-control" id="agazataiPotlek"
                                                name="agazataiPotlek">
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="szSzakkepzet"
                                                name="szSzakkepzet">
                                        </div>
                                        <div class="col">
                                            <p>Kifizetés módja</p>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Bezár</button>
                                <button type="submit" name='submit' value="Saveaa" class="btn btn-primary"
                                    data-toggle="modal" id='submit'>
                                    ment
                                </button>
                        </form>
                    </div>
