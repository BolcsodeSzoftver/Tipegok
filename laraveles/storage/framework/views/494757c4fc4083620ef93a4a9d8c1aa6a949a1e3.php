                                ...
                                <?php if($data->allapot === 1): ?>
                                    <tr class="dolgozo">
                                        ...
                                        <td class="t1 allandoLakhely" id=<?php echo e($data->id); ?>>
                                            <?php echo e($data->allando_lakhely); ?>
                                ...
                                <?php if($data->allapot === 1): ?>
                                    <?php if($bolcsode->id == $data->bolcsode_id && $data->users_id != Auth::user()->id): ?>
                                        <tr class="dolgozo">
                                            ...
                                            <td class="t1 telefonszam" id=<?php echo e($data->id); ?>><?php echo e($data->telefonszam); ?>

                                            </td>
                                            <td class="t1 anyjaNev" id=<?php echo e($data->id); ?>><?php echo e($data->anyja_neve); ?>

                                            </td>

                                            <td class="t2 szulN" id=<?php echo e($data->id); ?>><?php echo e($data->szul_nev); ?>

                                            </td>
                                            <td class="t2 szulH" id=<?php echo e($data->id); ?>><?php echo e($data->szul_hely); ?>

                                            </td>
                                            <td class="t2 szulI" id=<?php echo e($data->id); ?>><?php echo e($data->szul_ido); ?>
                                            ...
                                            <td class="t3 tartHely" id=<?php echo e($data->id); ?>>
                                                <?php echo e($data->tartozkodasi_hely); ?>

                                            </td>

                                            <td class="t4 taj" id=<?php echo e($data->id); ?>><?php echo e($data->tajszam); ?></td>
                                            <td class="t4 adoA" id=<?php echo e($data->id); ?>><?php echo e($data->adoazon_jel); ?>

                                            </td>
                                            <td class="t4 bankSz" id=<?php echo e($data->id); ?>>
                                                <?php echo e($data->banszamla_szam); ?>
        ...
        <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <<<<<<< HEAD <form action="api/alkalmazott/0" method="post">
                        <?php echo csrf_field(); ?>
                                ...
                                <div id="adatok1">
                                    <div class="col" id="gId">
                                        ...
                                        <form action="api/alkalmazott/0" method="post">
                                            ...
                                            <div class="modal-body">
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item"><a class="nav-link dolgozoModalAdatok1"
                                                            href="#">1</a></li>
                                                    <li class="nav-item"><a class="nav-link dolgozoModalAdatok2"
                                                            href="#">2</a></li>
                                                </ul>
                                                    ...
                                                    <div class="adatok1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <div class="form-outline">
                                                                    <input type="hidden" id="dolgozoId"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="anyjaNeve"
                                                                            class="form-control" name="anyjaNeve"
                                                                            readonly>
                                                                        <label class="form-label" for="anyjaNeve">Anyja
                                                                            neve</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="szulN"
                                                                            class="form-control" name="szulN" readonly>
                                                                        <label class="form-label" for="szulN">Születési
                                                                            név</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="szulH"
                                                                            class="form-control" name="szulH" readonly>
                                                                        <label class="form-label" for="szulH">Születési
                                                                            hely</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="szulI"
                                                                            class="form-control" name="szulI" readonly>
                                                                        <label class="form-label" for="szulI">Születési
                                                                            idő</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="allPorg"
                                                                            class="form-control" name="allPorg" readonly>
                                                                        <label class="form-label"
                                                                            for="allPorg">Államporgárság</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="tizenhatAGy"
                                                                            class="form-control" name="tizenhatAGy"
                                                                            readonly>
                                                                        <label class="form-label" for="tizenhatAGy">16
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-outline">
                                                                        <input type="text" id="hazas"
                                                                            class="form-control" name="hazas" readonly>
                                                                        <label class="form-label"
                                                                            for="hazas">Házas</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <hr>
                                                        ...
                                                        <<<<<<< HEAD <div id="adatok2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-outline">
                                                                        <input value="" type="text" id="allandoLak"
                                                                            class="form-control" name="allandoLak"
                                                                            readonly>
                                                                        <label class="form-label"
                                                                            for="allandoLak">Állandó lakhely</label>
                                                                    </div>
                                                                    =======
                                                                    <div class="adatok2">
                                                                        <h5></h5>
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                    <div class="form-outline">
                                                                                        <input type="text" id="tartHely"
                                                                                            class="form-control"
                                                                                            name="tartHely" readonly>
                                                                                        <label class="form-label"
                                                                                            for="tartHely">Tartózkodási
                                                                                            hely</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                    <div class="form-outline">
                                                                                        <input type="text" id="adoAzon"
                                                                                            class="form-control"
                                                                                            name="adoAzon" readonly>
                                                                                        <label class="form-label"
                                                                                            for="adoAzon">Adóazonósító</label>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col">
                                                                                    <div class="form-outline">
                                                                                        <input type="text" id="tajSz"
                                                                                            class="form-control"
                                                                                            name="tajSz" readonly>
                                                                                        <label class="form-label"
                                                                                            for="tajSz">Tajszám</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                    <div class="form-outline">
                                                                                        <input type="text" id="bankSZ"
                                                                                            class="form-control"
                                                                                            name="bankSZ" readonly>
                                                                                        <label class="form-label"
                                                                                            for="bankSZ">Bankszámla
                                                                                            szám</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
