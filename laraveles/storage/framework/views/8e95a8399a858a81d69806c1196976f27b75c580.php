...
<?php $__env->startSection('tartalom'); ?>
    ...
    <div class=row>
        <div class="form-group">
            <form action="<?php echo e(url('/dolgozo')); ?>" method="post">
                <?php echo e(csrf_field()); ?>

                <input type="text" name="keresDolgozo" required />
                                    ...
                                    <?php if($data->allapot === 1): ?>
                                        <?php if($bolcsode->id == $data->bolcsode_id): ?>
                                            <tr class="dolgozo">
                                                ...
                                                <td class="t4 taj" id=<?php echo e($data->id); ?>><?php echo e($data->tajszam); ?>
                                                ...
                                                <td class="t5 nem" id=<?php echo e($data->id); ?>><?php echo e($data->nem); ?></td>
                                                <td class="t5 hazas" id=<?php echo e($data->id); ?>><?php echo e($data->hazas_e); ?>
