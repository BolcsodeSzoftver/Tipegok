                    ...
                    @if ($data->users_id == Auth::user()->id)
                        <div id="adatok1">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="tel" class="form-control" name="tel" value={{ $data->telefonszam }}  readonly>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="szulH" class="form-control" name="szulH" value={{ $data->szul_hely }} readonly>
                                        <label class="form-label" for="szulH">Születési hely</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="szulI" class="form-control" name="szulI" value={{ $data->szul_ido }} readonly>
                                        <label class="form-label" for="szulI">Születési idő</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="allPorg" class="form-control" name="allPorg" value={{ $data->all_polgarsag }} readonly>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="tizenhatAGy" class="form-control" name="tizenhatAGy" value={{ $data->tizenhat_alatti_gyermek }} readonly>
                                ...
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="nem" class="form-control" name="nem" value={{ $data->nem }} readonly>
                                        <label class="form-label" for="nem">Nem</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="hazas" class="form-control" name="hazas" value={{ $data->hazas_e }} readonly>
                        ...
                        <div id="adatok2">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="tartHely" class="form-control" name="tartHely" value={{ $data->tartozkodasi_hely }} readonly>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="adoAzon" class="form-control" name="adoAzon" value={{ $data->adoazon_jel }} readonly>
                                        <label class="form-label" for="adoAzon">Adóazonósító</label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="tajSz" class="form-control" name="tajSz" value={{ $data->tajszam }} readonly>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="text" id="bankSZ" class="form-control" name="bankSZ" value={{ $data->banszamla_szam }} readonly>
